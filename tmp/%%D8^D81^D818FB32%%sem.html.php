<?php /* Smarty version 2.6.13, created on 2012-07-27 15:49:14
         compiled from dashboard/sem.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'number_format', 'dashboard/sem.html', 539, false),)), $this); ?>
<script type="text/javascript">
	var page = "project";
	var page_detail = "sem";
	var clicks = <?php echo $this->_tpl_vars['clickPerday']; ?>
;
	var kpiperday = <?php echo $this->_tpl_vars['kpiClick']; ?>
;
	var cpcperday = <?php echo $this->_tpl_vars['cpcPerDay']; ?>
;
	var ctrperday = <?php echo $this->_tpl_vars['ctrPerDay']; ?>
;
	var searchdisplay = <?php echo $this->_tpl_vars['searchdisplay']; ?>
;
	var expenditure = <?php echo $this->_tpl_vars['expenditure']; ?>
;
	var assets = <?php echo $this->_tpl_vars['assets']; ?>
;
	var maxChart = <?php echo $this->_tpl_vars['maxCPC']; ?>
;
	<?php echo '
...
<div id="body-tab">
	...
	<div class="flRight fgrey2 arial">Last Report on Generated on <span class="fwhite bold"><?php echo $this->_tpl_vars['lastUpdate']; ?>
</span></div>
</div>
<div class="body-content">
	<div class="body-content-head">
		...
		<form action="index.php?s=sem&id=<?php echo $this->_tpl_vars['id']; ?>
" method="post">
	...
	<div class="body-box-summary-small flLeft relative" style="z-index:1;">
		...
		<div class="summary-box-small2 flLeft relative">
			...
			<span  style="font-size:28px"><?php echo ((is_array($_tmp=$this->_tpl_vars['clickFromStart']['click'])) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
</span>
			<span class="absolute arial bold" style="right: 13px;top: 9px;"><?php echo ((is_array($_tmp=$this->_tpl_vars['clickFromStart']['percent'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : number_format($_tmp, 2)); ?>
%</span>
...
The percentage shows the sum of Clicks to Date divided by KPI multiplied by 100." style=" bottom: 5px;right: 10px;"></a>
		...
		<div class="summary-box-small2 flRight relative">
			...
			<span  style="font-size:28px"><?php echo ((is_array($_tmp=$this->_tpl_vars['clickThisMonth']['click'])) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
</span>
			<span class="absolute arial bold" style="right: 13px;top: 9px;"><?php echo ((is_array($_tmp=$this->_tpl_vars['clickThisMonth']['percent'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : number_format($_tmp, 2)); ?>
%</span>
...
" style=" bottom: 5px;right: 10px;"></a>
		...
		<div class="summary-box-small2 flLeft relative">
			...
			<span  style="font-size:28px"><?php echo ((is_array($_tmp=$this->_tpl_vars['ctrFromStart']['ctr'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : number_format($_tmp, 2)); ?>
%</span>
			<span class="absolute arial bold" style="right: 13px;top: 9px;"><?php if ($this->_tpl_vars['ctrFromStart']['percent'] > 0): ?>+<?php endif;  echo ((is_array($_tmp=$this->_tpl_vars['ctrFromStart']['percent'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : number_format($_tmp, 2)); ?>
%</span>
...
" style=" bottom: 5px;right: 10px;"></a>
		...
		<div class="summary-box-small2 flRight relative">
			...
			<?php if ($this->_tpl_vars['impact']): ?><span  style="font-size:28px"><?php echo $this->_tpl_vars['impact']; ?>
%</span><?php else: ?><span  style="font-size:20px">Data Not Available</span><?php endif; ?>
	...
	<div class="body-box-summary-small flRight relative" style="margin-right:-7px; z-index:1;">
		...
		<div class="summary-box-small2 flLeft relative">
			...
			<span  style="font-size:28px;margin-left:35px;"><?php echo $this->_tpl_vars['costThisMonth']['cost']; ?>
</span>
			<span class="absolute arial bold" style="right: 13px;top: 9px;"><?php if ($this->_tpl_vars['costThisMonth']['percent'] > 0): ?>+<?php endif;  echo ((is_array($_tmp=$this->_tpl_vars['costThisMonth']['percent'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : number_format($_tmp, 2)); ?>
%</span>
...
" style=" bottom: 5px;right: 10px;"></a>
		...
		<div class="summary-box-small2 flRight relative">
			...
			<span class="absolute" style="top:28px;left:10px;">USD</span>
			<span  style="font-size:28px;margin-left:35px;"><?php echo ((is_array($_tmp=$this->_tpl_vars['costFromStart']['cost'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : number_format($_tmp, 2)); ?>
</span>
			<span class="absolute arial bold" style="right: 13px;top: 9px;"><?php echo ((is_array($_tmp=$this->_tpl_vars['costFromStart']['percent'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : number_format($_tmp, 2)); ?>
%</span>
...
The percentage shows the sum of the total cost spent divided by the total budget  multiplied by 100." style=" bottom: 5px;right: 10px;"></a>
		...
		<div class="summary-box-med2 flLeft relative">
			...
			<span class="absolute" style="top:28px;left:10px;">USD</span>
			<span  style="font-size:28px;margin-left:35px;"><?php echo ((is_array($_tmp=$this->_tpl_vars['costFromStart']['budget'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : number_format($_tmp, 2)); ?>
</span>
...
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['topAds']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
		<tr><td><?php echo $this->_tpl_vars['topAds'][$this->_sections['i']['index']]['ads']; ?>
</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['topAds'][$this->_sections['i']['index']]['klik'])) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
</td></tr>
		<?php endfor; endif; ?>
		</tbody>
	</table>
	<table style="padding: 0;font-size: 11px; width:468px;" class="body-tbl flRight contentLeft fgrey2">
		...
		<?php unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['topKey']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['i']['show'] = true;
$this->_sections['i']['max'] = $this->_sections['i']['loop'];
$this->_sections['i']['step'] = 1;
$this->_sections['i']['start'] = $this->_sections['i']['step'] > 0 ? 0 : $this->_sections['i']['loop']-1;
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
		<tr><td><?php echo $this->_tpl_vars['topKey'][$this->_sections['i']['index']]['keyword']; ?>
</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['topKey'][$this->_sections['i']['index']]['klik'])) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
</td></tr>
		<?php endfor; endif; ?>
		</tbody>
	</table>
