...
<div id="body">
    ...
    <div class="nav">
		...
		<ul class="menu" id="menu">
            ...
            <li><a href="#">SEO</a>
            <ul>
                <li><a href="index.php?s=seo&act=upload-demog-report">Upload CSV Reporting for Demography</a></li>
            </ul>
            </li>
            <li><a href="#">SEM</a>
            	<ul>
                	<li><a href="index.php?s=sem">Upload Excel Report for Adwords Campaign</a></li>
					<li><a href="index.php?s=sem&act=upload_csv_ads">Upload Excel Report for Adwords Ads</a></li>
					<li><a href="index.php?s=sem&act=upload_csv_keyword">Upload Excel Report for Adwords Keywords</a></li>
                </ul>
            </li>
            <li><a href="#">SOCIAL</a></li>
            <li><a href="index.php?s=project">PROJECT</a>
            	<ul>
					<li><a href="index.php?s=project&act=create-project">CREATE PROJECT</a></li>
                	<li><a href="index.php?s=project&act=insert-budget">PROJECT BUDGET</a></li>
                </ul>
            </li>
        </ul>
